    ...
    useGSAP(() => {
        ...
        const maskTimeline = gsap.timeline({
            scrollTrigger: {
                trigger: '#art',
                start,
                // ~2.5 viewports of scroll for the whole sequence, so a fast wheel flick can't skip it
                end: '+=250%',
                scrub: 1.5,
                pin: true,
                anticipatePin: 1,
        ...
        // hold the final state while still pinned so the text is readable before it scrolls away
        .to({}, { duration: 1 })
    }, [isMobile])
  return (
    <div id="art">
